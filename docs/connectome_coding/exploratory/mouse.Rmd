...
```{r}
mouse.duke <- make_plots("mouse.duke", "Mouse dMRI", "Source ROI", "Target ROI", "region", "Source Region",
...
```{r}
mouse.allan <- make_plots("mouse.allan", "Mouse, Green Protein", "Source ROI", "Target ROI", "region",
