...
human.dmri.ase <- gs.embed.ase(human.mri, k=10, edge.attr="dMRI")
human.fmri.ase <- gs.embed.ase(human.mri, k=10, edge.attr="fMRI")
mouse.dim <- gs.dim.select(mouse.duke, edge.attr="weight", plot=TRUE)
mouse.ase <- gs.embed.ase(mouse.duke, k=10, edge.attr="weight")
fly.dim <- gs.dim.select(fly.left, edge.attr=NULL, plot=TRUE)
fly.ase <- gs.embed.ase(fly.left, k=10)
...
celegans.chem.ase <- gs.embed.ase(celegans.male, k=10, edge.attr="chem")
celegans.gap.ase <- gs.embed.ase(celegans.male, k=10, edge.attr="gap")
```
