...
celegans.plot <- gs.plot.grid(celegans.male, title="(A) Celegans Connectome", src.label="",
                              tgt.label="", edge.attr=c("chemical", "gap"), degree=TRUE)
...
human.dmri.sbm.plot <- gs.plot.sbm(human.dmri.sbm, edge.attr="dMRI", title="(D) Human dMRI SBM")
...
human.fmri.sbm.plot <- gs.plot.sbm(human.fmri.sbm, edge.attr="fMRI", title="(D) Human fMRI SBM")
...
mouse.sbm.plot <- gs.plot.sbm(mouse.sbm, edge.attr="weight", title="(C) Mouse dMRI SBM")

fly.sbm <- gs.sbm.fit(fly.left, community.attribute = "type", edge.attr=NULL)
fly.sbm.plot <- gs.plot.sbm(fly.sbm, edge.attr="weight", title="(B) Fly Mushroom Body SBM")
...
celegans.gap.sbm.plot <- gs.plot.sbm(celegans.gap.sbm, edge.attr="gap", title="(A.i) Celegans Gap SBM")
celegans.chem.sbm.plot <- gs.plot.sbm(celegans.chem.sbm, edge.attr="chem", title="(A.ii) Celegans Chemical SBM")
```
