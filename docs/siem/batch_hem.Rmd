...
```{r, warning=FALSE}
results2 <- rbind(case.experiment.within(dwi.models, dwi.datasets, dwi.subjects, 'dMRI', nrep=50),
      case.experiment.within(fmri.models, fmri.datasets, fmri.subjects, 'fMRI', nrep=50))
...
plot5 <- ggplot(results5, aes(x=modal, y=pval, color=dset1, shape=modal)) +
  geom_jitter(size=2) +
...
plot6 <- ggplot(results6, aes(x=modal, y=pval, color=dset1, shape=modal)) +
  geom_jitter(size=2) +
