...
#' @param start starting point for Frank-Wolfe Algorithm to solve the
#' relaxed seeded graph matching problem; defaulted to the barycenter of
#' the feasible region. Alternately, we could use a random doubly stochastic
#' matrix near the barycenter generated by \code{rsp}
