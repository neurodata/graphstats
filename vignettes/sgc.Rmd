...
# Display.
gs.plot.plot_matrix(A, title="2-SBM: Dense Blocks", legend.name="Connection", ffactor = TRUE)
...
# Display.
gs.plot.plot_matrix(A, title="2-SBM: Dense Between-Block Connections", legend.name="Connection", ffactor = TRUE)
...
With this utility, we have a full range of tools for the spectral analysis of graphs.
